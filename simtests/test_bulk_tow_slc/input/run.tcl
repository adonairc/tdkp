...
foreach m $models {
    ...
    set options(-plot)      "bands:transitions:optical_ascii:bands_ascii"
    set options(-model)     $m
    ...
    puts $f "set cb_bands_file \"cb_disp_$m\""
    puts $f "set vb_bands_file \"vb_disp_$m\""
    puts $f "set plot_slc_optics_file \"optics_$m\""
    puts $f "set plot_transitions_file \"transitions_${m}.dat\""
    close $f
