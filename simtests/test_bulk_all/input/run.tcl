...
$parser write_ascii_cplx2real [$solver get_bandstructure] "bands4x4.dat";
...
$solver solve $direction $kmin $kmax $nk
# write file bands.dat
$parser write_ascii_cplx2real [$solver get_bandstructure] "bands6x6.dat";
...
$solver solve $direction $kmin $kmax $nk
# write file bands.dat
$parser write_ascii_cplx2real [$solver get_bandstructure] "bands8x8.dat";


# calculate density of states
set dos_calculator [DensityOfStates -args 3]
$dos_calculator set_bandstructure 8 [$solver get_bandstructure]
