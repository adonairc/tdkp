# ------------------------------------------------------
# evaluate bands / matrix elements and gain
# ------------------------------------------------------

set ONLY_PROC_DEFINITIONS 1
source "../../../conf/default_config.tcl"
...
# k space definition
set kmax [expr {(2.0 * $constants_pi / 0.5) * 0.18}]
set kmin 0
...
$problem remove_all_energy_guesses
...
set cb_bands [$problem get_bandstructure 1];
